...
load Fig1DataConstrainedAminParams.mat
...
load Fig1DataConstrainedFrankParams.mat
...
load Fig1-3_constrainedShimizuParams.mat % load parameters for c<->L conversions
...
%% The actual figures
load('Fig1-2_stochasticDRC.mat','c','drc','kArray') % load data for plotting
